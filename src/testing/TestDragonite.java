...
public class TestDragonite {
	...
	public void testEvolutionMethod() {
		Dragonite dragonite = new Dragonite("AAA",4,"Dragonite is capable of flying faster than the speed of sound. It is a kindhearted Pokémon with human-like intelligence. It shows signs of altruism.","DRAGON","DRATINI", "270" );
		String temp ="DRATINI";
		assertEquals(temp,dragonite.getEvolution());		
		try {
